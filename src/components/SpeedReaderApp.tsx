...
export default function SpeedReaderApp() {
  ...
  if (appState === "INPUT") {
    return (
      <div className="w-full flex flex-col justify-between min-h-[85vh] max-w-2xl mx-auto pt-12 sm:pt-24">
        <div className="w-full flex flex-col gap-6">
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-800">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                onClick={() =>
                  handleFetchPreset("paulgraham.com/greatwork.html")
                }
        ...
        {/* Home Screen Footer */}
        <div className="w-full mt-auto pt-8 pb-8 border-t border-gray-200 dark:border-gray-800 flex flex-col items-center justify-center gap-4 text-xs font-mono text-gray-500">
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="https://github.com/shreyasbg"
              target="_blank"
          ...
          <div>made with ❤️ by shreyas</div>
        </div>
      </div>
    );
  }
